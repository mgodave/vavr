...
def generateMainClasses(): Unit = {
  ...
  def genTuples(): Unit = {
    ...
    def genTuple(i: Int)(im: ImportManager, packageName: String, className: String): String = {
      ...
      val ParameterList = (1 to i).gen(j => xs"""T$j _$j""")(" ,")
      ...
      xs"""
         ...
         */
        public record $className$generics(${ParameterList}) implements Tuple, ${im.getType("java.io.Serializable")} {
    ...
    genVavrFile("io.vavr", s"APITest", baseDir = TARGET_TEST)((im: ImportManager, packageName, className) => {
      ...
      def genAliasesTests(im: ImportManager, packageName: String, className: String): String = {
        ...
        xs"""
          ...
          ${genMediumAliasTest("Char", s"(Iterable<Character>) CharSeq", "'1'")}

          ${genMediumAliasTest("CharArray", s"(Iterable<Character>) CharSeq", "'1', '2', '3'")}

          ${genMediumAliasTest("CharSeq", s"(Iterable<Character>) CharSeq", "\"123\"")}
