...
public class IteratorTest extends AbstractTraversableTest {
    ...
    public void multipleHasNext() {
        ...
        multipleHasNext(() -> Iterator.of(1, 2, 3).scanLeft(1, Integer::sum));
        multipleHasNext(() -> Iterator.of(1, 2, 3).scanRight(1, Integer::sum));
        ...
        multipleHasNext(() -> Iterator.of(1, 2, 3, 4).zipWith(Iterator.of(1, 2), Integer::sum));
        multipleHasNext(() -> Iterator.of(1, 2, 3, 4).zipWithIndex());
        multipleHasNext(() -> Iterator.of(1, 2, 3, 4).zipWithIndex(Integer::sum));
    }
